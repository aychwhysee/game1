...
public class BlockOne {
    ...
    public BlockOne(int b_width, int b_height, int speed) {
    ...
    private BlockOne(Posn posn, int b_width, int b_height, int speed) {
        this.posn = posn;
        this.b_width = b_width;
        this.b_height = b_height;
        this.speed = speed;
    ...
    public BlockOne fall() {
        return new BlockOne(new Posn(this.posn.x, this.posn.y + speed),
